    ...
    public partial class AddExternalLoginTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__External__77860B2A12345678", x => x.ExternalLoginId);
                    table.ForeignKey(
                        name: "FK_ExternalLogins_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK__ExternalL__UserI__12345678",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalLogins_UserId1",
                table: "ExternalLogins",
                column: "UserId1");
        }
